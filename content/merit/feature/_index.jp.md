...
### ベイジの特長
  ...
  #### ビジネスにおける私たちの強み
  制作に関わる会社ならマーケティング、デザイン、マネジメントに長けてるのは当たり前では？と思うかもしれません。しかし多くの会社には、その中でも得意分野と苦手分野を持ち、その事業特性が働き方にも大きな影響を与えます。ここではその違いを詳しく解説します。

##### ビジネスを構造的に捉え問題の本質に迫るマーケティング力
  戦略フェーズでは、数々のフレームワークを活用し、約2カ月に渡ってリサーチと分析を繰り返し、この期間に作るドキュメント総数は枚を超えます。この骨太な戦略提案こそが、顧客との対等な関係性の源になっています。またこういった知見は自社の経営にも活かされており、年には年間400件以上の問い合わせを獲得しました。これほどの成果をあげる自社サイトを持つweb制作会社は日本国内でも稀です。ベイジで働くと、web制作会社としては異質ともいえるマーケティング文化を実感できます。
